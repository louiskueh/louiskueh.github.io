            ...
            <GridContainer>
              <div className={classes.typo}>
                ...
                <div className={classes.text}>
                  ...
                  <ul>
                    <li>Backend: Spring MVC &amp; Maven</li>
                    <li>Frontend: Thymeleaf, HTML, Bootstrap, Javascript, JQuery &amp; CSS </li>
                    <li>Quality Assurance: JUnit &amp; SonarQube</li>
                  </ul> */}
                  ...
                  <div className={classes.iconSize}>
                    ...
                    <img style={{position: 'absolute', bottom: 15, paddingLeft:5}} src={springBoot} height="48.75" width = "150" alt="Spring Boot" />
                  </div>
                </div>
